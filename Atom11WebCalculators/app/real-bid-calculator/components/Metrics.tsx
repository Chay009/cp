  ...
  return (
    <div className="p-6">
      ...
      <p className="text-gray-700 mb-6">
        Congratulations, your Ad Sales have increased by <span className="font-bold">+3.43%</span>.
        However, your ACOS has also increased by <span className="font-bold">+17.85%</span> in January 2022.
      </p> */}

      <div className="grid grid-cols-4 gap-4 mb-10">
        <div
          className={`p-4 rounded-lg shadow-sm flex flex-col border-solid border-2`}
        >
          <div className="flex items-center">
            <div className="bg-yellow-100 p-2 pl-2.5 pr-2.5 rounded-full">
          ...
          <div className="mt-4">
            {/* <p className="font-inter font-normal text-[14px] leading-[21px] text-[#B8C0CC]">
              Current
            </p> */}
            <div className="flex items-center">
        ...
        >
          <div className="flex items-center">
            <div className="bg-[#D6FFF1] p-2.5 pl-2.5 pr-2.5 rounded-full">
